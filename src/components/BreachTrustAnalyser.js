...
const BreachTrustAnalyser = () => {
  ...
  const breachTypes = [
    {
      ...
      description: 'Trustee purchased trust property or dealt with related party',
  ...
  const analyseBreach = () => {
    ...
    if (trusteeType === 'corporate') {
      consequences.push('Potential director liability under s 197 Corporations Act');
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-start">
                ...
                <span>Obtain urgent legal advice from specialist trust lawyer</span>
              </div>
              <div className="flex items-start">
