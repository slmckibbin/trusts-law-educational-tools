...
const InteractiveDutyChecker = () => {
  ...
  const duties = {
    ...
    traditional_duties: [
      ...
      { name: 'Not delegate inappropriately', source: 'General law and Qld (2025) ss 72–73', description: 'Enhanced delegation powers under <i>Trusts Act 2025<\i> (Qld).' },
...
| selectedScenario.triggers.includes('prudence')) {
      ...
      if (jurisdiction === 'qld2025') {
        applicableDuties.push('Enhanced duty of care (ss 65–7).');
